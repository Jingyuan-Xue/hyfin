...
class BaseEmbeddingModel:
    ...
    embedding_model: str # Class name indicating which vector service to use.
    ...
    def __init__(self, global_config: Optional[BaseConfig] = None) -> None:
        ...
        self.embedding_model = self.global_config.embedding_model

        logger.debug(f"Init {self.__class__.__name__}'s embedding_model with: {self.embedding_model}")
